...
_defineProperty(UserController, "createNewUser", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res, next) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          req.body.password = _context.v;
          _context.n = 2;
          return User.create(req.body);
        case 2:
          create = _context.v;
          _context.n = 3;
          return User.findById(create._id).select("-password");
        case 3:
          user = _context.v;
          return _context.a(2, ApiResponse.successResponse(res, "User created", user, null, StatusCodes.CREATED));
      }
    }, _callee);
  }));
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          users = _context2.v;
          return _context2.a(2, ApiResponse.successResponse(res, "success get users", users));
      }
    }, _callee2);
  }));
...
_defineProperty(UserController, "findUserById", /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          user_id = req.user.id;
          _context3.n = 1;
          return User.findById(user_id).select("-password");
        case 1:
          user = _context3.v;
          if (user) {
            _context3.n = 2;
        ...
        case 2:
          return _context3.a(2, ApiResponse.successResponse(res, "success get user", user));
      }
    }, _callee3);
  }));
...
_defineProperty(UserController, "updateUser", /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res, next) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        ...
        case 2:
          return _context4.a(2, ApiResponse.successResponse(res, "User updated successfully", user));
      }
    }, _callee4);
  }));
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(req, res, next) {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        ...
        case 2:
          return _context5.a(2, ApiResponse.successResponse(res, "success delete user", []));
      }
    }, _callee5);
  }));
