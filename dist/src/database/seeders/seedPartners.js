...
var _require3 = require("../../models/user.model"),
  User = _require3.User;
var total = process.argv[2] || 10; // jumlah input lewat argumen

_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  var users, partners, i, randomUser, _t;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.p = _context.n) {
      ...
      case 2:
        ...
        if (users.length === 0) {
          console.error("Tidak ada user dengan role PARTNER. Buat user terlebih dahulu.");
          process.exit(1);
        }
        partners = [];
        for (i = 0; i < total; i++) {
          ...
          partners.push({
            ...
            link_map: "https://www.google.com/maps/place/".concat(faker.location.city().replace(/\s/g, "+")),
      ...
      case 3:
        console.log("\u2705 Seeded ".concat(total, " fake partners successfully."));
        process.exit(0);
        _context.n = 5;
        break;
      case 4:
